            ...
            <HasAccess>
                {
                    ({userCan}) => <>
                        {
                            userCan([config.ROLES.ADMIN, config.ROLES.STATISTICS_USER]) && <li title={'dashboard'}>
                                <NavLink to={'/'} exact>
                        ...
                        <MenuParent icon={usersIcon} name={'Ходимлар '}>
                            ...
                            {userCan([config.ROLES.ADMIN]) && <li title={'users'}>
                                <NavLink to={'/ranks'}>
                        ...
                        <MenuParent icon={bookmarkIcon} name={'Умумий маълумотлар'}>
                            ...
                            {userCan([config.ROLES.ADMIN]) && <li>
                                <NavLink to={'/conditionperson'}>
                                    <ReactSVG src={clipboardIcon}/><span
                                    className={'text'}>Шахснинг ҳолати бўйича</span>
                                </NavLink>
                            </li>}
                            {userCan([config.ROLES.ADMIN]) && <li>
                                <NavLink to={'/working-place'}>
                                    <ReactSVG src={clipboardIcon}/><span
                                    className={'text'}>Жабрланган шахснинг бандлиги</span>
                            ...
                            {userCan([config.ROLES.ADMIN]) && <li>
                                <NavLink to={'/restrictions-type'}>
                                    <ReactSVG src={clipboardIcon}/><span
                                    className={'text'}> Белгиланган чекловлар</span>
                                </NavLink>
                            </li>}
                            {userCan([config.ROLES.ADMIN]) && <li>
                            ...
                            {userCan([config.ROLES.ADMIN]) && <li>
                                <NavLink to={'/criminal-codex'}>
                                    <ReactSVG src={clipboardIcon}/><span
                                    className={'text'}>Жиноят кодекси моддалари</span>
                                </NavLink>
                            </li>}
                            {userCan([config.ROLES.ADMIN]) && <li>
                            ...
                            {userCan([config.ROLES.ADMIN]) && <li>
                                <NavLink to={'/administrative-codex'}>
                                    <ReactSVG src={clipboardIcon}/><span
                                    className={'text'}>Маъмурий кодекси моддалари</span>
                                </NavLink>
                            </li>}
                            {userCan([config.ROLES.ADMIN]) && <li>
                            ...
                            {userCan([config.ROLES.ADMIN]) && <li>
                                <NavLink to={'/result-order'}>
                                    <ReactSVG src={clipboardIcon}/><span
                                    className={'text'}>Ҳимоя ордери бериш натижаси</span>
                                </NavLink>
                            </li>}
                        </MenuParent>}
